...
const HomePage = () => {
            ...
            try {
                if (!cookies.token) {
                    ...
                    if (!status) {
                        ...
                        const response = await axios.get(`https://wellness360backend.vercel.app/users/workouts/${user.userId}`);
    ...
    const handleSubmit = async (e) => {
        ...
        console.log(userId);
        try {
            const res = await axios.post('https://wellness360backend.vercel.app/users/workouts', { ...formData, userId });
    ...
    const handleUpdateWorkout = async (workoutId, updatedWorkout) => {
        try {
            ...
            await axios.put(`https://wellness360backend.vercel.app/users/workouts/${workoutId}`, updatedWorkout);
    ...
    const handleDeleteWorkout = async (workoutId) => {
        try {
            await axios.delete(`https://wellness360backend.vercel.app/users/workouts/${workoutId}`);
